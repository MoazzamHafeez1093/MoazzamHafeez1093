...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,100:00D9FF&height=200&section=header&text=Muhammad%20Moazzam%20Hafeez&fontSize=40&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=DevOps%20Engineer%20%7C%20Cloud%20Engineer%20%7C%20FAST%20NUCES%20Islamabad&descAlignY=55&descAlign=50" />

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=Building+scalable+cloud+infrastructure;AWS+%7C+Docker+%7C+Kubernetes+%7C+Terraform;CI%2FCD+Pipelines+%7C+GitOps+%7C+Linux;Always+learning%2C+always+shipping)](https://git.io/typing-svg)
...
looking_for: DevOps / Cloud Engineer roles (Pakistan + Remote)
```
...
<img src="https://skillicons.dev/icons?i=aws,docker,kubernetes,terraform,linux" height="50"/>

### ⚙️ Languages & Scripting
<img src="https://skillicons.dev/icons?i=python,bash,git,githubactions,vscode" height="50"/>
...
- 🔭 Deploying and benchmarking real AWS infrastructure
- 🌱 Deepening expertise in Kubernetes and GitOps workflows
- 💡 Automating everything that can be automated
- 📖 BS Computer Science — graduating from FAST NUCES Islamabad
...
![Profile Views](https://komarev.com/ghpvc/?username=MoazzamHafeez1093&color=00d9ff&style=flat-square&label=Profile+Views)
